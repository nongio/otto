    ...
    fn setup_desktop_connector(
        ...
        if let Some((compositor, overlay_count)) = result {
            ...
            let surface_data = SurfaceData {
                ...
                backdrop_dock_image: None,
                backdrop_switcher_image: None,
                backdrop_overlay_handed: None,
                backdrop_dock_stale: false,
                backdrop_switcher_stale: false,
                backdrop_overlay_stale: false,
                last_desktop_rebuild: None,
                backdrop_bg_image: None,
                backdrop_bg_raw: None,
                backdrop_bg_preblurred: false,
                backdrop_bg_dirty: false,
                ...
                window_dmabuf_element: None,
                subtree_candidate: None,
                subtree_since: None,
                window_plane_active: false,
                overlay_dmabuf_element: None,
                switcher_dmabuf_element: None,
                dock_dmabuf_element: None,
                dock_plane_position: None,
                overlay_fit: Default::default(),
                dock_fit: Default::default(),
                switcher_fit: Default::default(),
