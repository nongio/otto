...
declare -A PAGE_TITLE=(
    ...
    [dev/file-previews]="Otto File Previews - Thumbnails and Quick View"
...
declare -A PAGE_DESC=(
    ...
    [dev/file-previews]="How Otto Files builds previews: the thumbnail store, the shared cache, the preview column, Quick View's sandboxed decode worker, and video playback."
