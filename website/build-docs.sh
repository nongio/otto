...
declare -A PAGE_TITLE=(
    ...
    [nixos]="Otto on NixOS - Flake and programs.otto Module"
...
declare -A PAGE_DESC=(
    ...
    [nixos]="Install Otto on NixOS from its flake with the programs.otto module, and check the packaging in a VM."
