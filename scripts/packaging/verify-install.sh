...
for b in otto otto-bar otto-islands otto-lock otto-settings otto-files \
         otto-launcher otto-emoji otto-quickview otto-media-worker otto-greeter otto-rdp; do
...
for b in /usr/bin/otto /usr/bin/otto-bar /usr/bin/otto-islands /usr/bin/otto-lock \
         /usr/bin/otto-settings /usr/bin/otto-files /usr/bin/otto-launcher /usr/bin/otto-emoji \
