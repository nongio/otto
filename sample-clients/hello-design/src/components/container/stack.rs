...
impl Stack {
    ...
    fn layout_vertical(&mut self, x: f32, mut y: f32, available_width: f32, available_height: f32) {
    ...
    fn layout_horizontal(&mut self, mut x: f32, y: f32, available_width: f32, available_height: f32) {
...
mod tests {
    ...
    fn test_stack_with_padding() {
        let mut stack = Stack::new(StackDirection::Vertical)
            .with_padding(EdgeInsets::uniform(10.0));
