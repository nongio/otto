...
fn tray_menu_style() -> MenuBarStyle {
    ...
    MenuBarStyle {
        ...
        hover_color: skia_safe::Color::from_argb(50, 255, 255, 255),
        active_color: skia_safe::Color::from_argb(100, 255, 255, 255),
...
fn left_menu_style() -> MenuBarStyle {
    ...
    MenuBarStyle {
        ...
        active_color: skia_safe::Color::from_argb(80, 255, 255, 255),
        icon_tint: theme.text_primary,
