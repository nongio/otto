...
otto-agents is the agents service: it runs ACP agents and serves them over AHP. The launcher is the GUI, and every Otto surface is an AHP client (see 0003 and 0007).
