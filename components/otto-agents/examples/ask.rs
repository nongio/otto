//! Sends one prompt to a running otto-agents server.
//!
...
//!
//! ```sh
//! cargo run -p otto-agents --example ask -- --folder ~/dev/otto-agents "summarise the README"
...
struct Args {
    ...
    #[arg(long, env = "OTTO_AGENTS_URL", default_value_t = otto_agents::client::default_url())]
    url: String,
