...
//!
//! One JSON file per session, in `$XDG_STATE_HOME/otto-ahp/sessions/`. What
//! is stored is otto-ahp's own part: the session's and its chat's AHP state,
...
impl Store {
    ...
    /// `$XDG_STATE_HOME/otto-ahp/sessions`, or `~/.local/state/otto-ahp/sessions`.
    pub fn default_dir() -> Option<PathBuf> {
        ...
        Some(state_home.join("otto-ahp").join("sessions"))
    }
