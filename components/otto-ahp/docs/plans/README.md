...
otto-ahp is the agents service: it runs ACP agents and serves them over AHP. `otto-agents`
is the GUI, and every Otto surface is an AHP client (see 0003 and 0007).
...
| 0009 | [otto-agents app](0009-otto-agents-app.md) | Draft | 0002, 0004, 0005, 0007 |
