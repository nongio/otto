...
pub struct DialogRequest {
    pub id: DialogId,
    pub app_id: String,
    /// The caller's own name for this dialog, so it can take it down again
    /// when whatever it was asking about has been settled elsewhere. Empty
...
mod tests {
    ...
    /// Parses otto-agents' `dump_prompt_for_render` output into a view.
    ...
    /// Renders `/tmp/claude-1000/shots/prompt.txt` (see otto-agents'
