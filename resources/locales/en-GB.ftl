...
schema-accent-color-description = Accent colour used by Otto's own interface: a palette name, which follows the light and dark schemes, or a #RRGGBB colour.
schema-rounded-corners-label = Rounded corners
schema-rounded-corners-description = Round the corners of the dock, the top bar, window decorations and the panels the desktop draws itself.
