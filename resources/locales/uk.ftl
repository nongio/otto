...
schema-accent-color-description = Колір акценту, який використовує власний інтерфейс Otto: назва з палітри, яка відповідає світлій і темній кольоровим схемам, або колір #RRGGBB.
schema-rounded-corners-label = Заокруглені кути
schema-rounded-corners-description = Заокруглює кути Dock, верхньої панелі, оформлення вікон, а також панелей, які малює сама стільниця.
