...
schema-rounded-corners-description = Arrondit les coins du Dock, de la barre supérieure, des décorations de fenêtre et des sélecteurs d’espace de travail et de fenêtre.
