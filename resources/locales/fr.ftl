...
schema-accent-color-description = Couleur d’accentuation utilisée par l’interface propre d’Otto : un nom de la palette, qui suit les jeux de couleurs clair et sombre, ou une couleur #RRGGBB.
schema-rounded-corners-label = Coins arrondis
schema-rounded-corners-description = Arrondit les coins du Dock, de la barre supérieure, des décorations de fenêtre et des panneaux que le bureau dessine lui-même.
