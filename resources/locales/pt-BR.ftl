...
schema-rounded-corners-description = Arredonda os cantos do Dock, da barra superior, das decorações de janela e dos seletores de área de trabalho e de janela.
