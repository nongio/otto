...
schema-accent-color-description = Cor de destaque usada pela própria interface do Otto: um nome da paleta, que acompanha os esquemas de cores claro e escuro, ou uma cor #RRGGBB.
schema-rounded-corners-label = Cantos arredondados
schema-rounded-corners-description = Arredonda os cantos do Dock, da barra superior, das decorações de janela e dos painéis que a própria área de trabalho desenha.
