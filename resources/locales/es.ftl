...
schema-accent-color-description = Nombre del color de acento que usa la propia interfaz de Otto.
schema-rounded-corners-label = Esquinas redondeadas
schema-rounded-corners-description = Redondea las esquinas del Dock, la barra superior, las decoraciones de ventana y los selectores de espacio de trabajo y de ventana.
