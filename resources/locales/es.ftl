...
schema-accent-color-description = Color de acento que usa la propia interfaz de Otto: un nombre de la paleta, que sigue los esquemas de colores claro y oscuro, o un color #RRGGBB.
schema-rounded-corners-label = Esquinas redondeadas
schema-rounded-corners-description = Redondea las esquinas del Dock, la barra superior, las decoraciones de ventana y los paneles que dibuja el propio escritorio.
