...
schema-accent-color-description = Kolor akcentu używany przez własny interfejs Otto: nazwa z palety, która podąża za jasnym i ciemnym schematem kolorów, albo kolor #RRGGBB.
schema-rounded-corners-label = Zaokrąglone rogi
schema-rounded-corners-description = Zaokrągla rogi Docka, górnego paska, dekoracji okien oraz paneli rysowanych przez samo środowisko.
