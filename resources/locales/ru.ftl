...
schema-accent-color-description = Цвет акцента, используемый собственным интерфейсом Otto: название из палитры, которое следует светлой и тёмной цветовым схемам, или цвет #RRGGBB.
schema-rounded-corners-label = Скруглённые углы
schema-rounded-corners-description = Скругляет углы Dock, верхней панели, оформления окон, а также панелей, которые рисует сам рабочий стол.
