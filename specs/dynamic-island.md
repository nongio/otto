...
machine don't move the bars. With none of the player's streams running, the track
plays on another device: a phone or a network speaker (Spotify Connect, a cast), even
while other apps play locally. After a second
